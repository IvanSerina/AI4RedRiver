(define (domain sproblem_2002_09_30_end_2003_05_31-domain)
  ...
  (:constants
    hoa_binh_dam - dam
    son_tay - node
    vu_quang_station yen_bai_station input_hoa_binh - regular
  ...
  (:action update_state_network
    :parameters ( ?d - day)
    :precondition (and (active ?d) (not (evaluated_network)) (< 3317.789292 (- (storage hoa_binh_dam) (* 0.0864 (+ (release_spillways hoa_binh_dam) (+ (release_bottom hoa_binh_dam) (release hoa_binh_dam)))))) (< (- (storage hoa_binh_dam) (* 0.0864 (+ (release_spillways hoa_binh_dam) (+ (release_bottom hoa_binh_dam) (release hoa_binh_dam))))) (/ (- (max_level_dam ?d) 60.79) 0.00579)))
    :effect (and (assign
        (flow son_tay)
        (+ (* 0.9381251024 (lagged_flow vu_quang_station)) (+ (* 0.9142836768 (lagged_flow yen_bai_station)) (* 0.9753053897 (lagged_flow hoa_binh_dam))))) (assign
        (level hanoi)
        (+ 1.251048082 (+ (* 0.00118589898 (+ 65.73542924 (+ (* 0.9381251024 (lagged_flow vu_quang_station)) (+ (* 0.9142836768 (lagged_flow yen_bai_station)) (* 0.9753053897 (lagged_flow hoa_binh_dam)))))) (+ (* -0.00000005707615536000 (* (+ 65.73542924 (+ (* 0.9381251024 (lagged_flow vu_quang_station)) (+ (* 0.9142836768 (lagged_flow yen_bai_station)) (* 0.9753053897 (lagged_flow hoa_binh_dam))))) (+ 65.73542924 (+ (* 0.9381251024 (lagged_flow vu_quang_station)) (+ (* 0.9142836768 (lagged_flow yen_bai_station)) (* 0.9753053897 (lagged_flow hoa_binh_dam))))))) (* 0.00000000000119447651 (* (+ 65.73542924 (+ (* 0.9381251024 (lagged_flow vu_quang_station)) (+ (* 0.9142836768 (lagged_flow yen_bai_station)) (* 0.9753053897 (lagged_flow hoa_binh_dam))))) (* (+ 65.73542924 (+ (* 0.9381251024 (lagged_flow vu_quang_station)) (+ (* 0.9142836768 (lagged_flow yen_bai_station)) (* 0.9753053897 (lagged_flow hoa_binh_dam))))) (+ 65.73542924 (+ (* 0.9381251024 (lagged_flow vu_quang_station)) (+ (* 0.9142836768 (lagged_flow yen_bai_station)) (* 0.9753053897 (lagged_flow hoa_binh_dam)))))))))))) (assign
  ...
  (:action advance_day
    ...
    :precondition (and (active ?d1) (next_step ?d1 ?d2) (evaluated_network) (< 1.4 (level hanoi)) (< (level hanoi) 11.5) (< (+ 500 (agricultural_demand ?d1)) (+ 65.73542924 (flow son_tay))) (< (objective) 999999))
